...
\usepackage{xcolor}  % Required for colors like blue!20


% 3. NOW it is safe to use \tikzset
...
\usetikzlibrary{shapes, arrows.meta, positioning, calc, mindmap, shadows, trees, patterns}
