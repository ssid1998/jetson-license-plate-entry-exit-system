...
When implemented in frameworks like PyTorch, these components are seamlessly integrated into the model, allowing for end-to-end training and inference. On embedded platforms such as the Jetson Nano, this integration enables real-time execution of CNNs for applications like license plate detection without compromising performance \cite{pytorchdocs, jetsonpytorch}.
 ...
 \begin{figure}[H]
 	\centering
 	\includegraphics[width=0.4\textwidth]{../../Images/CNN_Algorithm/cat.png}
 	\caption{Example of CNN-based image classification.}
 \end{figure}
 ...
 \begin{figure}[H]
 	\centering
 	\includegraphics[width=0.4\textwidth]{../../Images/CNN_Algorithm/car.png}
 	\caption{Example of CNN-based object detection.}
 \end{figure}
 ...
 \begin{figure}[H]
 	\centering
 	\includegraphics[width=0.4\textwidth]{../../Images/CNN_Algorithm/medical_segmentation.jpg}	
 	\caption{Example of CNN-based image segmentation.}
 \end{figure}
 ...
 \begin{figure}[H]
 	\centering
 	\includegraphics[width=0.4\textwidth]{../../Images/CNN_Algorithm/action.png}
 	\caption{Example of CNN-based video analysis.}
 \end{figure}
