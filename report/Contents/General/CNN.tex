...
\begin{figure}[H]
	\centering
	\input{../../tikz/4DomainKnowledgeML/CNN/CNNProcess.tikz}
...
\begin{figure}[htbp]
	\centering
	\input{../../tikz/4DomainKnowledgeML/CNN/CNNWorkflow.tikz}
...
\begin{figure}[H]
	\centering
	\input{../../tikz/4DomainKnowledgeML/CNN/FeatureMaps.tikz}
...
\begin{figure}[H]
	\centering
	\input{../../tikz/4DomainKnowledgeML/CNN/KernelStridePadding.tikz}
