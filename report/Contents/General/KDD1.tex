...
\begin{figure}[htbp]
	\centering
	\input{../../tikz/7DomainKnowledgeAppDev/KddProcess.tikz}
...
\begin{table}[htbp]
	...
	\begin{tabular}{@{}lcccc@{}}
		...
		Training & 70\% & 870 & $\sim$915 & Model fitting (Weights) \\
		Validation & 20\% & 249 & $\sim$260 & Hyperparameter tuning \\
		Testing & 10\% & 124 & $\sim$130 & Final evaluation (Unseen) \\ \midrule
		\textbf{Total} & \textbf{100\%} & \textbf{1,243} & \textbf{$\sim$1,305} & \\ \bottomrule
	\end{tabular}
\end{table}
...
\subsection{\textcolor{red}{One Database: Data Structure}}
\TBD{Check if this is the correct understanding of One database}
...
\subsection{Outliers: Handling Outliers}
...
\subsection{Anomalies: Anomaly Detection}
...
\subsection{Augmentation: Data Augmentation Techniques}
...
\begin{figure}[htbp]
	\centering
	\input{../../tikz/7DomainKnowledgeAppDev/AugmentationStrategy.tikz}
...
%\begin{figure}[htbp]
%	\centering
%	\input{../../tikz/7DomainKnowledgeAppDev/TechStack.tikz}
