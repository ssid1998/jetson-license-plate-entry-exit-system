\chapter{\textcolor{red}{Comparative Analysis: Edge Impulse vs.\ Our Implementation}}
...
\begin{figure}[htbp]
	\centering
	\input{../../tikz/7DomainKnowledgeAppDev/EdgeImpulseComparison/EdgeImpulseVsCustomPipeline.tikz}
...
\begin{figure}[htbp]
	\centering
	\input{../../tikz/7DomainKnowledgeAppDev/EdgeImpulseComparison/EdgeImpulseLifecycleLoop.tikz}
...
\begin{figure}[htbp]
	\centering
	\input{../../tikz/7DomainKnowledgeAppDev/EdgeImpulseComparison/JetsonDeploymentStackComparison.tikz}
