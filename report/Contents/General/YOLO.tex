...
\chapter{\textcolor{red}{Core Algorithm - YOLO}}
\index{YOLO}
...
\begin{figure}[htbp]
	\centering
	\input{../../tikz/4DomainKnowledgeML/YOLO/YoloPipeline.tikz}
...
\subsection{Installation on Desktop or General Linux}
...
\subsection{Installation Notes for Jetson Nano}
