...
\begin{table}[h!]
	\begin{tabular}{||m{1cm}|m{2.2cm}|m{2.5cm}|m{1.5cm}|m{1.7cm}|m{1cm}|m{3cm}||}
		...
		\hline
		1 & NVIDIA Jetson Nano Developer Kit & GPU Based AI controller and its Kit & \includegraphics[width=1.5cm]{Images/Developer_Kit} & 1 & 214€ & \href{https://www.seeedstudio.com/Jetson-10-1-A0-p-5336.html}{Jetson-Nano}\\
		\hline
