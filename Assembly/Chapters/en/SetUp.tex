...
\begin{figure}[H]
	...
	\includegraphics[width=.85\linewidth]{General/flashingSdCard.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{General/jetsonTopLayout.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{General/wiringOverview.png}
