...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        \vspace{0.5cm}
        \textsf{\LARGE Car License Plate Identification with a Jetson Nano}\\
        \textsf{\LARGE J1010}
    \end{flushright}
    ...
    \begin{tabbing}
        ...
        Author: \> Mansour Ahmady Phoulady \\
        Matriculation No.: \> 7025671 \\
%        Course of Studies: \> Business Intelligence and Data Analytics \\ [0.25cm]

		Author: \> Hemanth Prabhakaran \\
