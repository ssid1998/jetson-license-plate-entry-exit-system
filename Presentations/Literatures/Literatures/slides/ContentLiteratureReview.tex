...
\STANDARD{Topic 29: Real-Time Automatic License Plate Detection and Blurring Using the European Union Dataset}
{ 
	\textbf{Description:}
	
	This paper presents the THI License Plate Dataset (TLPD), a large EU dataset with over 17,000 vehicle images and 18,000 labeled license plates. It covers varied angles, distances, lighting, and weather conditions to support robust license plate detection. A fast annotation tool enables efficient labeling. Two detection networks trained on TLPD achieved 93\% precision and recall under normal conditions and 87\% in heavy snow. Motivated by European data protection laws, the work supports real-time license plate detection and blurring for privacy protection.\autocite{Chan:2023}
	
	\textbf{Keywords:}
	
	License Plate Detection, European Dataset, Annotation Tool, Machine Learning, Deep Learning, Computer Vision, Real-Time Processing, Privacy Protection, Intelligent Transportation Systems.
}
