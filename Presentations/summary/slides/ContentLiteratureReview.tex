...
\STANDARD{Challenge 1: Storage Constraints}
{
	...
	\begin{tabular}{|p{0.48\linewidth}|p{0.48\linewidth}|}
		...
		$\bullet$ \textbf{No SD Slot:} Our unit is the \textit{Jetson Nano Production Module} (P3448), which disables the SD card slot by design. \newline
		...
		$\bullet$ \textbf{Result:} Solved the space issue and increased data read speeds by 5x (400 MB/s). \\
		\hline
	\end{tabular}
}
% ==============================================================================
